      ...
      <TextContainer className="border">
        <DetailsWrap>
          ...
          <Details>
            <h2>Chris' Skills</h2>
            <p className="text">
              With the pace of modern web development, the learning never stops.
              I continue to refine and expand my skillset to stay up-to-date
              with the latest trends in web development.
            </p>
            <p className="text">
              My skills include: HTML, CSS, jQuery, AJAX, REST, Git, Github,
              SCSS, Sass, Firebase, SQL, mongoDB, Axios, Express.js, Node.js,
